		...
		<div class="row" style="text-align: center">
	      <div class="col-md-12">
			...
			<c:if test="${pageBean.currenPage !=1 }">
				<a href="${pageContext.request.contextPath }/dept_listDetPage.action?currenPage=${pageBean.currenPage-1}">上一页</a>
			</c:if>
			<c:if test="${pageBean.currenPage !=pageBean.totalPage }">
				<a href="${pageContext.request.contextPath }/dept_listDetPage.action?currenPage=${pageBean.currenPage+1}">下一页</a>
			</c:if> 
	       </div>
		</div>
	</div>
